...
interface AnalyticsData {
  ...
  platformConnections: Array<{ name: string; connections: number }>
}
...
export default function DashboardPage() {
  ...
  const categoryData = [
    { name: "Social Feed", value: 35, color: "var(--color-chart-1)" },
    { name: "Messaging", value: 25, color: "var(--color-chart-2)" },
    { name: "Communities", value: 20, color: "var(--color-chart-3)" },
    { name: "Content", value: 12, color: "var(--color-chart-4)" },
    ...
    return (
      <div className="min-h-screen bg-background">
        <div className="relative">
          <nav className="border-b border-border bg-card/50 backdrop-blur-sm fixed top-4 left-0 right-0 mx-auto max-w-6xl bg-card/80 backdrop-blur-md border border-border rounded-xl shadow-lg z-50">
              ...
              <div className="flex items-center justify-between h-16">
                <div className="flex items-center space-x-8">
                  <Link href="/" className="flex items-center space-x-2">
                    ...
                    <span className="font-bold text-xl text-foreground">Socia Analytics</span>
                  </Link>
  ...
  if (!analyticsData) {
    return (
      <div className="min-h-screen bg-background">
        <div className="relative">
          <nav className="fixed top-4 left-0 right-0 mx-auto max-w-6xl bg-card/80 backdrop-blur-md border border-border rounded-xl shadow-lg z-50">
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Real-time insights from your social media analytics platform</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-foreground">{analyticsData.totalPlatforms}</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          {/* Platform Connections Chart */}
          <Card>
            <CardHeader>
              <CardTitle>Platform Connections</CardTitle>
              <CardDescription>Number of wallet connections per platform</CardDescription>
            </CardHeader>
            <CardContent>
              <ChartContainer
                config={{
              ...
              >
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={analyticsData.platformConnections}>
        ...
        {/* Category Distribution and Top Platforms */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Category Distribution */}
          <Card>
            <CardHeader>
              <CardTitle>Platform Categories</CardTitle>
              <CardDescription>Distribution of platforms by category</CardDescription>
            </CardHeader>
            <CardContent>
              <ChartContainer
                config={{
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Platforms with highest user engagement</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {analyticsData.platformConnections.map((platform, index) => (
                  <div key={index} className="flex items-center justify-between p-3 bg-muted/30 rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">{platform.connections} connections</p>
                      </div>
                    </div>
